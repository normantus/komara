                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group date">
                                                                    ...
                                                                    <input type="text" class="form-control pull-right datepicker" id="tgl_pemeriksaan" name="tgl_pemeriksaan">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
...
<script>
    ...
    function save_cctv_problem()
    {
       ...
       $.ajax({
        url : "<?php echo site_url('cctv/cctv_problem/save_cctv_problem') ?>",
        type: "POST",
