                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control input-md" id="no_problem" name="no_problem" value="<?php echo $list_toko[0]->FAKTUR;?>" readonly>
                                                            </div>
                                                        </div>           
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" id="kode_toko" name="kode_toko" maxlength="4" autofocus onkeypress="return jquery_get_detail_toko(event)" onkeyup="uppercase(this)">
                                                                    <span class="input-group-btn">
                                                                        <button class="btn btn-flat btn-info" type="button" data-toggle="modal" data-target="#listToko">List Toko</button>
                                                                    </span>
                                                                </div><!-- /input-group -->
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <textarea type="text" class="form-control input-md" id="info_kerusakan" name="info_kerusakan" maxlength="500" value=""></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group date">
                                                                    ...
                                                                    <input type="text" class="form-control pull-right datepicker" id="tgl_pemeriksaan" name="tgl_pemeriksaan" value="<?php echo $date->format("d-m-Y"); ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <textarea type="text" class="form-control input-md" id="pemeriksaan_it" name="pemeriksaan_it" maxlength="500" value=""></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" id="nik_pic_it" name="nik_pic_it" maxlength="8" onkeypress="return jquery_get_detail_it_store(event)">
                                                                    <span class="input-group-btn">
                                                            ...
                                                            <div class="col-md-3">
                                                                <input type="text" class="form-control input-md" id="nama_pic_it" name="nama_pic_it" maxlength="8" value="" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    ...
    function save_cctv_problem()
    {
       ...
       $.ajax({
        url : "../cctv_problem/save_cctv_problem",
        type: "POST",
        ...
        success: function(data)
        {
               ...
               alert('Berhasil menambahkan problem CCTV');
             },
             error: function (jqXHR, textStatus, errorThrown)
             {
                swal({
