                ...
                <form id="form_problem_cctv" class="form-horizontal">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <div class="pull-left">
                            <a style="color: #d9534f" type="button" class="btn btn-box-tool" href="<?php echo base_url('cctv/cctv_problem/dashboard');?>"><i class="fa fa-arrow-left fa-2x"></i></a>
                            </div>
                            <div class="pull-right">
                                <a type="button" class="btn btn-danger btn-flat" href="<?php echo base_url('cctv/cctv_problem/dashboard');?>"> Close</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group date">
                                                                    ...
                                                                    <input type="text" class="form-control pull-right" id="tgl_kirim_vendor" name="tgl_kirim_vendor" value="<?php echo $data->SEND_VENDOR_DATE; ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    ...
    function update_cctv_problem()
    {
       ...
       $.ajax({
        url : "../../cctv_problem/update_cctv_problem",
        type: "POST",
