  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo $photo; ?>" class="img-circle elevation-2 " style="width: 55px;" alt="User Image">
        </div>
        <div class="info">
          <a class="d-block"><?php echo ucwords(strtolower($first_name .' '. $last_name)); ?></a>
          <a href="<?php echo $menu?>logout" class="d-block badge bg-danger">Logout</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo $menu.'dashboard'; ?>" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?php echo $menu.'store/new-problem'; ?>" class="nav-link">
